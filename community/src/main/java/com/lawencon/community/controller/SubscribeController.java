...
public class SubscribeController {
	...
	@PostMapping
	public ResponseEntity<InsertSubscribeDtoRes> insert(@RequestBody @Valid InsertSubscribeDtoReq data) throws Exception{
	...
	@PutMapping
	public ResponseEntity<UpdateSubscribeDtoRes> update(@RequestBody @Valid UpdateSubscribeDtoReq data) throws Exception{
